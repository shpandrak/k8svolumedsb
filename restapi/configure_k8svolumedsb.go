...
import (
	...
	"ocopea/k8svolumedsb/restapi/operations"
	"ocopea/k8svolumedsb/restapi/operations/dsb_web"
	"ocopea/k8svolumedsb/restapi/impl"
	"os"
	"fmt"
)
...
//go:generate swagger generate server --target .. --name k8svolumedsb --spec ../dsb-swagger.yaml
var k8s *k8sClient.Client
func configureFlags(api *operations.K8svolumedsbAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.K8svolumedsbAPI) http.Handler {
	var k8sURL string
